...
public class WorldOreGenerator {
	...
	private boolean darfnicht;

	public WorldOreGenerator(int par1, int par2)
    {
                    ...
                    for (int var41 = var33; var41 <= var36; ++var41)
                    {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D)
                        {
                            for (int var44 = var34; var44 <= var37; ++var44)
                            {
                                ...
                                {
                                	if(par1World.getBlockId(var38, var41, var44) == Block.stone.blockID || par1World.getBlockId(var38, var41, var44) == 0){
                                		darfnicht = false;
                                		par1World.setBlockAndMetadata(var38, var41, var44, this.minableBlockId, 0);
                                	}
                                }
                            }
                        }
